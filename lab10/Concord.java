...
public class Concord {
    ...
    public void printSorted(PrintStream out) {
    	ArrayList< Map.Entry<String, Integer> > entryArrayList = new ArrayList( concord.entrySet() );

    	// System.out.print( entryArrayList.get(0));
    	// System.out.print( entryArrayList.get(1));
    	// System.out.println();

    	EntryComparator myEntryComparator = new EntryComparator();
    	Collections.sort( entryArrayList , myEntryComparator );

    	for (Map.Entry<String, Integer> anEntry : entryArrayList) {
    ...
    public ArrayList< Map.Entry<String, Integer> > findLongest() {
    	ArrayList< Map.Entry<String, Integer> > result = new ArrayList();

    	ArrayList< Map.Entry<String, Integer> > entryArrayList = new ArrayList( concord.entrySet() );
    	Iterator<Map.Entry<String, Integer>> iter = entryArrayList.iterator();

    	EntryLengthComparator myEntryComparator2 = new EntryLengthComparator();
    	while(iter.hasNext() ){
    	...
    	Collections.sort( entryArrayList , myEntryComparator2 ); 

		result.add( entryArrayList.get(0) );

		System.out.println(entryArrayList);
    	
    	int i = 1;
    	int maxLength = entryArrayList.get(0).getKey().length();
    	int curLength = entryArrayList.get(i).getKey().length();
    	while( curLength == maxLength ){
			result.add( entryArrayList.get(i) );
			i++;
			curLength = entryArrayList.get(i).getKey().length();
    	}
    	return result;
    }
}
